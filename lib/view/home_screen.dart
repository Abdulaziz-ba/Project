...
import 'package:brandz/view/searched_products.dart';
                ...
                return FlatButton(
                  onPressed: () async {
                    ...
                    var object = Product(
                        ...
                        quantitiy: 1,
                        description: noteInfo['productDescription'].toString());

                    Navigator.of(context).pushReplacement(MaterialPageRoute(
                        builder: (context) =>
                            product_from_home(id: displayProduct.toString())));
                  },
                  child: Card(
                ...
                onFieldSubmitted: (text) async {
                  ...
                  await FirebaseFirestore.instance
                    ...
                    value.docs.forEach((doc) {
                      ...
                      if (doc.data()['BrandName'].toString() == text) {
                        flag = true;
                      }
                    });
                  });
