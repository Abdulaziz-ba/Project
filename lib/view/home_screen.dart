...
import 'package:brandz/searched_products.dart';
...
class _HomeViewState extends State<HomeView> {
        ...
        child: Text('Categories' , style: GoogleFonts.adamina(
          ...
          fontSize: 22
                  ...
                  SizedBox(
                    ...
                    children: [
                     Text('Brands' , style: GoogleFonts.adamina(
          color: Colors.black,
          fontSize: 22
                      ...
                      FlatButton(
                        onPressed: () { 
                               Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => BrandzCategory(id: "ALL",)));
 ...
 dynamic displayProduct = data.docs[index].id.toString();
    ...
    MaterialPageRoute(builder: (context) => product_page(id : displayProduct.toString())));
                ...
                onFieldSubmitted: (text) async {
                  ...
                  await FirebaseFirestore.instance
                    ...
                    value.docs.forEach((doc) {
                      ...
                      if (doc.data()['BrandName'].toString() == text.capitalizeFirst) {
                        flag = true;
                      }
                    });
                  });
